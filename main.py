...
cv2.imwrite('Imagen_C.jpg', imagen_C)
cv2.imwrite('Imagen_D.jpg', imagen_D)
cv2.imwrite('Imagen_E.jpg', imagen_E)
cv2.imwrite('Imagen_F.jpg', imagen_F)
cv2.imwrite('Imagen_G.jpg', imagen_G)
cv2.imwrite('Imagen_tipos.jpg', np.bitwise_not(output))
